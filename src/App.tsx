...
export default function App() {
  ...
  const handlePlay = () => {
    ...
    playerRef.current.play(tracks, audioBufferMapRef.current, playMax);
    setIsPlaying(true);
  };
  ...
  const handleSeek = (time: number) => {
    ...
    playerRef.current.seek(targetTime, tracks, audioBufferMapRef.current, playMax);
          ...
          <div className="bg-[#1D006B] border-2 border-[#1AA7C7] text-white rounded-xl shadow-2xl p-6 max-w-md w-full space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-end gap-2 pt-2">
              <button
                ...
                className="w-full sm:w-auto px-4 py-2 rounded-lg bg-[#005B9E] hover:bg-[#1AA7C7] hover:text-[#1D006B] text-white font-bold text-xs transition-all border border-[#1AA7C7]/50 shadow-md"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-4 py-2 rounded-lg bg-[#0A018A] hover:bg-[#1AA7C7] hover:text-[#1D006B] text-white font-bold text-xs transition-all border border-[#1AA7C7]/40 cursor-pointer"
              >
                🔄 Reintentar
              </button>
